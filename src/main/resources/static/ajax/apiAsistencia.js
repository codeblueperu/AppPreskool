          ...
          if(asistencia.length > 0){
		   ...
		   let situacion = `<div class="col-lg-9">
					<div class="form-check form-check-inline">
						<input class="form-check-input rbnstatus" type="radio" name="status${data[i].idEstudiante}" value="1" id="p${data[i].idEstudiante}" value="option1" ${present}>
						<label class="form-check-label" for="p${data[i].idEstudiante}">
						Presente
						</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input rbnstatus" type="radio" name="status${data[i].idEstudiante}" value="2" id="t${data[i].idEstudiante}" value="option2" ${tarde}>
						<label class="form-check-label" for="t${data[i].idEstudiante}">
						Tarde
						</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input rbnstatus" type="radio" name="status${data[i].idEstudiante}" value="0" id="a${data[i].idEstudiante}" value="option2" ${ausente}>
